...
%\newcommand{\OverflowLength}{0}
%\newcommand{\OverflowSide}{r}
%
%\NewDocumentCommand{\OverflowFigure}{mm}{
%\renewcommand{\OverflowFigureLeft}{#1}
%\renewcommand{\OverflowFigureRight}{#2}
%}
...
\newmdenv[linecolor=red,frametitle=Infobox]{CalloutAlert}
