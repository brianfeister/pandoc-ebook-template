...
\AfterEndEnvironment{VariaTable}{\BreakingTable\EmptyTableCaption}
...
$if(background)$
\tikz [overlay, remember picture] \node at (current page.center) {\includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio]{$background$}};
$else$
