...
**Fatigued - Power Level 5** (Entropy) **Defense:** Toughness

This bane has multiple stages. Each time it is inflicted, the target’s
current stage increases by 1. Effects are cumulative. **Stage 1:**
Disadvantage 1 on all non-attack rolls. **Stage 2:** Lose attribute
bonus to defense scores **Stage 3:** Disadvantage 1 on all attack rolls.
**Stage 4:** Speed is reduced to 10’. **Stage 5:** Unconsciousness.
**Stage 6:** Death.
...
**Forced Move - Power Level 2** (Might, Movement, Energy) **Defense:**
Toughness
...
**Incapacitated - Power Level 5** (Agility, Entropy, Enchantment)
...
**Intimidated - Power Level 4** (Enchantment, Might, Presence
Persuasion) **Defense:** Resolve
...
**Immobile - Power Level 0** (Agility, Enchantment, Entropy, Energy,
Alteration, Might) **Defenses:** Evasion, Resolve, or Toughness
...
**Persistent Damage - Power Level 4** (Agility, Energy, Entropy)
...
**Phantasm - Power Level 1** (Illusion) **Defense:** Resolve
...
**Silenced - Power Level 2** (Agility, Might, Energy, Alteration)
**Defense:** Evasion or Toughness
...
**Slowed - Power Level 2** (Energy, Might, Agility, Entropy)
**Defense:** Toughness
...
**Stunned - Power Level 4** (Might, Agility, Entropy, Energy)
**Defense:** Toughness
...
**Augury - Power Level 3** (Divination) **Invocation Time:** 1 Minute
...
**Blindsight - Power Level 5** (Divination, Psychic, Alteration)
...
**Darkness - Power Level 2** (Entropy, Illusion) **Invocation Time:**
normal action
...
**Detection - Power Level 3** (Divination) **Invocation Time:** normal
action
...
**Heal - Power Level 1** (Creation) **Invocation Time:** normal action
...
**Levitation - Power Level 5** (Movement, Psychic) **Invocation Time:**
normal action
...
**Light - Power Level 1** (Creation, Energy) **Invocation Time:** minor
action
...
**Regeneration - Power Level 3** (Alteration, Creation, Psychic)
**Invocation Time:** normal action
...
**Resistance - Power Level 3** (Abjuration, Energy) **Invocation Time:**
normal action
...
**Restoration - Power Level 1** (Abjuration, Creation) **Invocation
Time:** normal action
...
**Seeing - Power Level 5** (Divination) **Invocation Time:** normal
action
...
**Shapeshift - Power Level 2** (Alteration) **Invocation Time:** normal
action
...
unlocked: **Alteration 3:** Size between half and double original. Gain
non-flight movement capabilities. **Alteration 4:** Size between
one-quarter and quadruple original. **Alteration 5:** Flying movements
available.

**Duration:** Sustain persists

**Telepathy - Power Level 5** (Divination) **Invocation Time:** normal
action
...
**Teleport - Power Level 3** (Movement, Psychic) **Invocation Time:**
move action
...
**Transmute - Power Level 3** (Alteration) **Invocation Time:** 1 minute
